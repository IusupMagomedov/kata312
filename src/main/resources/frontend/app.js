    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch('http://localhost:8080/api/admin/users', {
                            method: 'GET',
                            headers: {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    users.forEach(function (user) {
                        console.log("User: ".concat(user.name, " ").concat(user.lastName, ", Email: ").concat(user.email, ", Roles: ").concat(user.stringRoles));
                    });
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _a.sent();
                    console.error('Failed to fetch users:', error_2);
                    return [3 /*break*/, 3];
